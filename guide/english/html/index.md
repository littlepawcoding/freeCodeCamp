...
HTML5 Introduces a host of semantic elements. Though as previously discussed, HTML helped to provide meaning to our document. It wasn't until HTML5s' introduction of [semantic elements](https://guide.freecodecamp.org/html/html5-semantic-elements) that the full potential was realized.
